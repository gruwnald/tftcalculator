function level_coefficient(level, cost) {
    var lev = {1: [1, 0, 0, 0, 0], 2: [1, 0, 0, 0, 0], 3: [0.75, 0.25, 0, 0, 0], 4: [0.55, 0.30, 0.15, 0, 0],
        5: [0.45, 0.33, 0.20, 0.02, 0], 6: [0.30, 0.40, 0.25, 0.05, 0], 7: [0.19, 0.35, 0.35, 0.10, 0.01],
        8: [0.18, 0.25, 0.36, 0.18, 0.03], 9: [0.10, 0.20, 0.25, 0.35, 0.10], 10: [0.05, 0.10, 0.20, 0.40, 0.25],
...
function unit_copies(cost) {
    var units = {1:22, 2:20, 3:17, 4:10, 5:9};
    return units[cost];
}
